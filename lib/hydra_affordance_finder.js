 ...
 * @param {*} compactedBody response body
 * @param {string} rel link relation name
 * @returns {Promise.<Affordance>}
 */
HydraAffordanceFinder.prototype.findAffordance = function (compactedBody, rel) {

  var self = this;

  var objectAtRel = self.findObjectAtRel(compactedBody, rel);
